...
extension HomeView {
    ...
    private var columnTitles: some View {
        HStack {
            RowTitle(
                title: "Coin",
                isIconShown: vm.sortOption == .rank || vm.sortOption == .rankReversed,
                tapGestureValue: vm.sortOption.rankTapGesture
            )
            ...
            if showPorfolio {
                RowTitle(
                    title: "Holdings",
                    isIconShown: vm.sortOption == .holdings || vm.sortOption == .holdingsReversed,
                    tapGestureValue: vm.sortOption.holdingsTapGesture
            ...
            RowTitle(
                title: "Price",
                isIconShown: vm.sortOption == .price || vm.sortOption == .priceReversed,
                tapGestureValue: vm.sortOption.priceTapGesture
            )
